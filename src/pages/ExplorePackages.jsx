...
// });
//   return (
//     <div className="min-h-screen bg-[#f5f7fb] flex gradient">
...
//                 className="w-full py-4 pl-14 pr-5 rounded-full border border-gray-200 bg-white
//                 text-gray-800 font-medium shadow-sm outline-none transition-all duration-300 placeholder:text-gray-400
//                 focus:border-blue-400 focus:ring-4 focus:ring-blue-100"
//               />
//               {searchTerm && (
//                 <button
//                   onClick={() => setSearchTerm("")}
//                   className="absolute right-5 top-1/2 -translate-y-1/2 text-gray-500 hover:text-red-500 text-lg">
//                   <X />
//                 </button>
//               )}
...
//             <div className="flex gap-4 ml-15 overflow-x-auto scrollbar-hide flex-1">
...
//         <div className="mb-8">
//           <h1 className="text-4xl md:text-5xl text-center font-bold text-gray-900 mb-3">
//             Explore Packages 
//           </h1>
...
//             <div
//               key={index}
//               className="bg-white rounded-3xl overflow-hidden shadow-md hover:shadow-2xl hover:-translate-y-2 transition-all duration-500"
//             >
...
//                 <button className="absolute top-4 right-4 bg-white/80 backdrop-blur-md w-10 h-10 rounded-full text-xl">
//                   ♡
//                 </button>
//               </div>
...
//                       {item.title}
//                     </h2>
//                     <p className="flex items-center gap-1 text-gray-500 text-sm font-serif">
//                         <MapPin /> 
//                         {item.location}
//                     </p>
//                   </div>
...
//                   <button className="bg-blue-600 text-white px-5 py-2 rounded-full hover:bg-blue-700 transition-all duration-300">
//                     Book Now
//                   </button>
//                 </div>
//               </div>
...
//           <button className="bg-blue-600 text-white px-8 py-4 rounded-full font-semibold hover:scale-105 transition-all duration-300 shadow-lg">
//             Load More Packages
//           </button>
//         </div>
//       </div>
    ...
    <div className="min-h-screen bg-[#f5f7fb] gradient">
      <div className="p-4 md:p-10">
              ...
              >
                ...
                <div className="p-3 md:p-6">
                  ...
                  <div className="flex items-center justify-between mt-3 md:mt-5 gap-2">
                    ...
                    <button className="bg-blue-600 text-white px-3 md:px-5 py-1.5 md:py-2 text-xs md:text-base rounded-full hover:bg-blue-700 transition-all duration-300">
                      Book
                    </button>
                  </div>
                </div>
        ...
        <div className="flex justify-center mt-10 md:mt-12">
          <button className="bg-blue-600 text-white px-6 md:px-8 py-3 md:py-4 rounded-full font-semibold hover:scale-105 transition-all duration-300 shadow-lg">
            Load More Packages
          </button>
        </div>
      </div>
