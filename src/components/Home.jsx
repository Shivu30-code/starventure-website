...
//     const phoneNumber = "918155855935";
...
//             Explore the World with Star Venture
//           </h1>

//           <p className="mt-4 text-gray-300 text-lg">
//             Flights • Hotels • Visa • Tour Packages — All in One Place
//           </p>

//           <div className="mt-6 flex justify-center gap-4">

//             <button className="bg-blue-600 px-6 py-3 rounded-xl hover:bg-blue-900 hover:font-bold transition duration-300">
//               Explore Packages
//             </button>

//             <button
//               onClick={handleWhatsAppBooking}
//               className="flex items-center gap-2 border border-white px-6 py-3 rounded-xl hover:bg-white hover:text-black hover:font-semibold transition duration-300"
//             >
