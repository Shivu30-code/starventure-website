        ...
        <div className="relative px-1 md:px-10">
          ...
          >
            {Popularpackages.map((item, index) => (
              <div
                key={index}
                className="min-w-[55%] sm:min-w-[45%] md:min-w-[31%] lg:min-w-[28%] xl:min-w-[25%] 
bg-white group relative overflow-hidden shadow-xl 
rounded-b-[30px] rounded-t-[100px] md:rounded-b-[35px] md:rounded-t-[140px] 
transition-all duration-500 ease-in-out 
hover:scale-[1.03] hover:-translate-y-2 hover:shadow-2xl flex-shrink-0"
              >
